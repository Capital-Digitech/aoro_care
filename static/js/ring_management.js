...
/* ---------------------------------------------------------
   ...
   Same behavior as Hospital Management.
...
/* ---------------------------------------------------------
   ...
   Pure UI filter — does not touch server pagination/query
   logic.
--------------------------------------------------------- */
function initTableSearchFilter(){
  const searchInput =
    document.getElementById('hrRingSearch');

  const connectionFilter =
    document.getElementById('hrFilterConnection');

  const statusFilter =
    document.getElementById('hrFilterStatus');

  const modelFilter =
    document.getElementById('hrFilterModel');

  const resetBtn =
    document.getElementById('hrResetFilters');

  const table =
    document.getElementById('hrRingTable');
...
function initDeleteModal(){
  const modal =
    document.getElementById('hrDeleteModal');
  ...
  modal.addEventListener(
    ...
    (event) => {
      ...
      if(form && ringId){
        ...
        /*
         * Keep this path only if your Flask route is:
         * /health-ring/delete/<id>
         */
        form.action =
          `/health-ring/delete/${ringId}`;
      }
    }
  );
}
...
/* ---------------------------------------------------------
   ...
   Wire .hr-page-btn clicks to Flask pagination
   (?page=N) when server-side pagination is connected.
--------------------------------------------------------- */
